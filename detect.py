...
def run(
        ...
        source=ROOT / 'data/tomatoD/test/images',  # file/dir/URL/glob/screen/0(webcam)
        data=ROOT / 'data/val.yaml',  # dataset.yaml path
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / 'data/WEDU/test/images', help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default=ROOT / 'data/val.yaml', help='(optional) dataset.yaml path')
